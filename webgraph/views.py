...
def dashboard(request, *args, **kwargs):
    return render(request, 'webgraph/dashboard.html')

def generateGraph(request, sp, dg, tp, pz, sc, ct, *args, **kwargs):
    try:
    ...
    plt.savefig(os.path.join(BASE_DIR, 'static/webgraph/ad.png')) #have to show this in first graph div
    ...
    plt.savefig(os.path.join(BASE_DIR, 'static/webgraph/rd.png')) # have to show this in second graph div
